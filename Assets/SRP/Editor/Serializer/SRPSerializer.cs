...
public static class SRPSerializer {

	public static void Serialize(object o, SerializedProperty prop) {
		if(o == null) {
	...
	public static void SerializeArray(object[] o, SerializedProperty prop) {
		SerializeCollectionComponent(o, prop);
		return;
	}

	public static object[] Deserialize(Type t, SerializedProperty prop) {
